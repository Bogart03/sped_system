...
if (isset($_GET['delete_id'])) {
    ...
    $conn->query("DELETE FROM color_game_results WHERE id = $delete_id");
...
if (isset($_GET['reset_all'])) {
    $conn->query("DELETE FROM color_game_results");
    header("Location: color_results.php");
    exit;
}
...
<div class="container admin py-4">
    ...
    <div class="d-flex justify-content-between mb-3">
        <div>
            ...
            <!-- <a href="export_color_results_excel.php" class="btn btn-sm btn-success btn-icon">
